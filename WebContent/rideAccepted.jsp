...
//Create a connection string
			...
			String rideAccepted=("DELETE FROM Rider WHERE departure='"+dep +"'and destination='"+dest+"'and timeWindow='"+time+"'and username='"+uname+"'");
			
			int result = stmt.executeUpdate(rideAccepted);	
			
			if(result>0){
				out.print("alert("+'"'+ "Accepted"+'"'+")"+"';'");
			}
